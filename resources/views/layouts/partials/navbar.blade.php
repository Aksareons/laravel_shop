    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link waves-effect" href="{{ route('admin.index') }}">Admin</a>
                </li>
                @else <p> </p>
                @endif
            </ul>
            ...
            <ul class="navbar-nav nav-flex-icons">
                ...
                @if(\Cart::session(\Session::getId())->getTotalQuantity() > 0 )<li><a href="{{route ('cart.index')}}">{{\Cart::session(\Session::getId())->getTotalQuantity()}} </a></li> @else @endif
                @guest
                    <li class="nav-item">
